...
// Constructor
Card::Card(CardName name, CardType type) : name(name), type(type) {}
...
WeaponCard::WeaponCard(CardName name, int difficulty, int damage) : Card(name, CardType::WEAPON), difficulty(difficulty), damage(damage) {}