...
int Player::play_card_phase() {
    ...
    print_hand();
    std::cout << "Entrez le numéro d'une carte pour la jouer, ou rien si vous avez fini / passez votre tour : " << std::endl;
    int response;
    std::cin >> response;
    ...
    std::cout << "Vous avez joué : " << hand[response].print_name() << std::endl;
	return response;
}
